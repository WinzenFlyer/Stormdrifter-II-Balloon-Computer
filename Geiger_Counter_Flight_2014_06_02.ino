/*
 * Program Code for PTB Lindenberg 2013 Flight Board by University of Osnabruck
 * Based on the EURUS Balloon Code by James Coxon (GPS), Anthony Stirk's NTX2 RTTY code and Tom Igoe's SD Library.
 * Electrometer Based on Giles Harrison's 2001 Paper in Review of Scientific Instruments (and also his 2008 and 2009 papers).
